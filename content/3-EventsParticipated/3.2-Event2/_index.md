...
<div style="display: flex; gap: 10px; justify-content: center; align-items: flex-start; flex-wrap: wrap; margin-top: 20px;">
  <div style="flex: 1; min-width: 300px; text-align: center;">
    ...
    <p style="font-size: 0.9em; color: #666; margin-top: 8px;">Memories with speakers and the community</p>
  </div>
  <div style="flex: 1; min-width: 300px; text-align: center;">
    ...
    <p style="font-size: 0.9em; color: #666; margin-top: 8px;">Check-in at the event</p>
  </div>
</div>
