...
<div style="display: flex; gap: 10px; justify-content: center; align-items: flex-start; flex-wrap: wrap; margin-top: 20px;">
  <div style="flex: 1; min-width: 250px; text-align: center;">
    ...
    <p style="font-size: 0.9em; color: #666; margin-top: 8px;">Tech Solution Updates</p>
  </div>
  <div style="flex: 1; min-width: 250px; text-align: center;">
    ...
    <p style="font-size: 0.9em; color: #666; margin-top: 8px;">AWS Community Memories 1</p>
  </div>
  <div style="flex: 1; min-width: 250px; text-align: center;">
    ...
    <p style="font-size: 0.9em; color: #666; margin-top: 8px;">AWS Community Memories 2</p>
  </div>
</div>
