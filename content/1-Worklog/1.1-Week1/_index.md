...
* Familiarize with the work environment, culture, and members of the FCJ team.
* Set up an AWS account and essential cost management tools (AWS Budget).
* Acquire foundational knowledge of the AWS ecosystem and core service categories.
* Initiate project brainstorming and master Identity and Access Management (IAM) basics.
...
* Successfully integrated with the team and understood internship regulations.
* AWS account is ready with a Budget set up for effective cost control.
* Gained a clear overview of Compute, Storage, Database, and Networking services on AWS.
* Finalized the project idea and completed critical IAM hands-on labs.
